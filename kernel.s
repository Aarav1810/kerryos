; This kernel is taken from https://github.com/appusajeev/os-dev-16
...
readcmd:	; read an exe name from the user
	...
	mov di,[bp+18]
	continue_read:
		mov ah,0						; int 10h call 0x00, read input
		int 16h							; call int16h to read keyboard input
		cmp al,0dh
		jz fin
		mov ah,0x0e						; print the key
		mov bx,0
		int 10h
		stosb
		inc byte [charcount]
...
welcome db "Welcome to KerryOS",10,13,0
erro db "Error loading sector of the floppy",10,13,0
